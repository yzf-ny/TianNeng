    ...
    <script>
                ...
                , success: function (json) {
                    ...
                    for (var i = 0; i < list.length; i++) {
                        var add =
                            ...
                            + "<div style='margin-top: 150px'><button class='btn btn-transparent' onclick='update("+list[i].cid+")'><i class='fa fa-pencil'></i> </button>"
                            + " </div></td></tr>"
                            + "<tr><td style='width: 80px'>联系人：</td>"
                            + "<td >" + list[i].coperate + "</td></tr>"
                            + "<tr><td >电话：</td>"
                            + "<td >" + list[i].cphone + "</td></tr>"
                            + "<tr><td >传真：</td>"
                            + "<td >" + list[i].cfac + "</td></tr>"
                            + "<tr><td >QQ：</td>"
                            + "<td >" + list[i].cqq + "</td></tr>"
                            + "<tr><td >Email：</td>"
                            + "<td >" + list[i].cemail + "</td></tr>"
                            + "<tr><td >官网地址：</td>"
                            + "<td >" + list[i].chttps + "</td></tr>"
                            + "<tr><td >地址：</td>"
                            + "<td >" + list[i].caddress + "</td></tr>"
        ...
        function update(cid)
        {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: ["history/updateContact.jsp?num="+num+"&cid="+cid,"no"]
            });
            ...
            <div class="content-header">
                <div class="leftside-content-header">
                    <ul class="breadcrumbs">
                        ...
                        <li><i class="fa fa-home" aria-hidden="true"></i><a href="#">联系我们</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            ...
                            <h4 class="section-subtitle"><b>联系我们信息表</b></h4>
                            <div class="panel">
