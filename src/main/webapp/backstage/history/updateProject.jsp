    ...
    <script type="text/javascript">
       ...
       // $("#filename").html("支持 jpg|png图片类型")
               ...
               // alert("pid:"+pid)
                $.ajax({
                    ...
                    , success: function (json) {
                        $("#proname").val(json.pname);
                        $("#source").val(json.psource);
                        $("#txt").html(json.ptext);
                        $("#filename").html(json.pimg);
                    }
                })
        })
        ...
        function ok() {
            ...
            {
                layer.msg("名称不能为空",{icon:2,time:3000});
                return ;
            }
        ...
        function repeat(txt, proname,source,filename) {
           // alert(txt);
            $.ajax({
                url: '../project/update'
                , type: 'POST'
                , data: {'txt': txt, 'source':source,'name': proname, 'pimg':filename,'pid':${param.pid}}
                , success: function (i) {
