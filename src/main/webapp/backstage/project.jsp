...
<head>
    ...
    <script>
       //layer.msg("asdfasga")
        ...
        $(function () {
            ...
            $("#add").click(function () {
                ...
                layer.open({
                    ...
                    fixed: false, //不固定
                    maxmin: true,
                    content: ["history/addProject.jsp","no"]
                });
            })
        ...
        //         + "<h4 class='tl-title' >" + list.stime + "</h4>"
        //         + list.stext
        //         + "</div> "
        //         + "</div>"
        //     $("#timeline").append(add);
            ...
            $.ajax({
                ...
                , success: function (json) {
                    ...
                    for (var i = 0; i < list.length; i++) {
                        var add = "<tr>"
                            + "<td><input type='checkbox' name='singlecheck' value='"+list[i].pid+"'></td>"
                            + "<td style='text-align: center'>" + (i+1) + "</td>"
                            + "<td style='text-align: center'>" + list[i].pname + "</td>"
                            + "<td style='text-align: center'>" + list[i].ptime + "</td>"
                            + "<td style='text-align: center'>" + list[i].pnum + "</td>"
                            + "<td style='text-align: center'>" + list[i].psource + "</td>"
                           //  + "<td style='width: 0px;word-wrap: break-word' >" + list[i].pimg + "</td>"
                            + "<td style='width: 250px'>" + list[i].ptext + "</td>"
                            + "<td style='text-align: center'>"
                            + "<div class='btn-group btn-group-xs' style='width: 70px'>"
                            + "<button class='btn btn-transparent' onclick='update("+list[i].pid+")'><i class='fa fa-pencil'></i> </button>"
                            + "<button class='btn btn-transparent' onclick='deletes("+list[i].pid+")'><i class='fa fa-times'></i> </button>"
                            + " </div></td></tr>";
                        $("#tbody").append(add);
                    }
                }
        ...
        function update(pid)
        {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: ["history/updateProject.jsp?num="+num+"&pid="+pid,"no"]
            });
                    ...
                    <nav>
                        <ul class="nav" id="main-nav">
                            ...
                            <li class="has-child-item close-item">
                                ...
                                <ul class="nav child-nav level-1">
                                    <li><a href="widgets_boxes.html">项目信息</a></li>
                                </ul>
                            </li>
            ...
            <div class="content-header">
                <div class="leftside-content-header">
                    <ul class="breadcrumbs">
                        ...
                        <li><i class="fa fa-home" aria-hidden="true"></i><a href="#">项目信息</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            ...
                            <h4 class="section-subtitle"><b>项目信息表</b></h4>
                            <div class="panel">
                                <div class="panel-header">
                                    <span>显示(页/条数):</span><span class="code"><select id="select">
                                        ...
                                        <option>30</option>
                                        <option>50</option>
                                    </select> </span><span style="margin-left: 75%" >
