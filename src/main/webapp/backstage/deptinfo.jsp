    ...
    <script>
        ...
        $(function () {
            ...
            $("#add").click(function () {
                ...
                layer.open({
                    ...
                    fixed: false, //不固定
                    maxmin: true,
                    content: ["history/addDeptinfo.jsp?","no"]
                });
            });
                ...
                , success: function (json) {
                    ...
                    for (var i = 0; i < list.length; i++) {
                        ...
                        if(over==0){
                            ...
                            ty="上架";
                        var add =
                            "<tr ><td>----------------</td> <td>------------------</td> <td rowspan='5' style='width: 100px' >"
                            + "<div class='btn-group btn-group-xs' style='width: text-align: center;margin-top:  50%'>"
                            + "<a class='btn btn-transparent' style='color: "+red+"' onclick='outover("+list[i].id+","+over+")'>"+ty+"</i> </a>"
                            + "<button class='btn btn-transparent' onclick='update("+list[i].id+")'><i class='fa fa-pencil'></i> </button>"
                            + "<button class='btn btn-transparent' onclick='deletes("+list[i].id+")'><i class='fa fa-times'></i> </button>"
                            + " </div></td></tr>"
                            + "<tr><td style='width: 50px'>编号:</td>"
                            + "<td >" + (i+1) + "</td></tr>"
                            + "<tr><td >时间：</td>"
                            + "<td >" + list[i].dtime + "</td></tr>"
                            + "<tr><td >职位：</td>"
                            + "<td >" + list[i].dname + "</td></tr>"
                            + "<tr><td >职位要求：</td>"
                            + "<td >" + list[i].duty + "</td></tr>"
        ...
        function outover(id,type)
        {
            ...
            if(type==0){
                ...
                type=0;
            layer.confirm('确定要'+tx, {
                    btn: [tx, '算了'] //按钮
                }, function (index) {

                    $.ajax({
                        url:'../deptinfo/updateType'
                        ,type:'POST'
        ...
        function update(id)
        {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: ["history/updateDeptinfo.jsp?num="+num+"&id="+id,"no"]
            });
            ...
            <div class="content-header">
                <div class="leftside-content-header">
                    <ul class="breadcrumbs">
                        ...
                        <li><i class="fa fa-home" aria-hidden="true"></i><a href="#">人事管理</a></li>
                        <li><i class="fa fa-home" aria-hidden="true"></i><a href="#">招聘信息</a></li>
                    </ul>
                </div>
            </div>
