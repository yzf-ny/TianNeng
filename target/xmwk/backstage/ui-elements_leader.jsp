    ...
    <script>
        ...
        $(function () {
            ...
            $("#add").click(function () {
                ...
                layer.open({
                    ...
                    fixed: false, //不固定
                    maxmin: true,
                    content: ["history/addLeader.jsp", "no"]
                });
            })
            ...
            $.ajax({
                ...
                , success: function (json) {
                    ...
                    for (var i = 0; i < list.length; i++) {
                        var add = "<tr>"
                            + "<td><input type='checkbox' name='singlecheck' value='" + list[i].sid + "'></td>"
                            + "<td style='text-align: center'>" + (i + 1) + "</td>"
                            + "<td style='text-align: center'>" + list[i].stime + "</td>"
                            + "<td style='text-align: center'>" + list[i].sname + "</td>"
                            + "<td style='width: 600px'>" + list[i].stext + "</td>"
                            + "<td style='text-align: center'>"
                            + "<div class='btn-group btn-group-xs'>"
                            + "<a href='#" + list[i].stime + "' class='btn btn-transparent' ><i class='fa fa-eye'></i>"
                            + "  </a>"
                            + "<button class='btn btn-transparent' onclick='update(" + list[i].sid + ")'><i class='fa fa-pencil'></i> </button>"
                            + "<button class='btn btn-transparent' onclick='deletes(" + list[i].sid + ")'><i class='fa fa-times'></i> </button>"
                            + " </div></td></tr>";
                        $("#tbody").append(add);
        ...
        function update(sid) {
            ...
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: ["history/updateLeader.jsp?num=" + num + "&sid=" + sid, "no"]
            });
            ...
            <div class="content-header">
                <div class="leftside-content-header">
                    <ul class="breadcrumbs">
                        ...
                        <li><i class="fa fa-home" aria-hidden="true"></i><a href="#">领导致辞</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            ...
                            <h4 class="section-subtitle"><b>领导致辞信息表</b></h4>
                            <div class="panel">
