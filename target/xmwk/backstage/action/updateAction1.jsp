...
<div>
    <div>
        <div class="layui-inline">
            <span><label >来源:</label>
            <input class="form-control" type="text" style="width: 600px" id="source" ></span>
            <span><label  style="margin-left: 0%">项目名称:</label><input class="form-control" type="text" style="width: 600px" id="proname"></span>
        </div>
    </div>
    <br>
    ...
    <script type="text/javascript">
               ...
               // alert("pid:"+aid)
                $.ajax({
                    ...
                    , success: function (json) {
                        $("#proname").val(json.atitle);
                        $("#source").val(json.asource);
                        $("#txt").html(json.atext);
                        $("#filename").html(json.aimg);
                    }
                })
        })
        ...
        function repeat(txt, proname,source,filename) {
            $.ajax({
                url: '../action/update'
                , type: 'POST'//String txt, String source, String title, String aimg,int type, int aid
                , data: {'txt': txt, 'source':source,'title': proname, 'aimg':filename,'type':${param.type},'aid':${param.aid}}
                , success: function (i) {
