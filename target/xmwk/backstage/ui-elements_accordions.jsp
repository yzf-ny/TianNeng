        ...
        function recovery(obj) {
            ...
            $.ajax({
                ...
                , success: function (cul) {
                  if(cul.size==1)
                  {
                      layer.msg("恢复成功",{icon:1,time:3000})
                  }
                    var child = $("#edit").children();
                    child.html("");
                    var t = cul.list.ctext;
                    child.remove();
                    $("#edit").append(cul.list.ctext);
                }
            })
        }
            ...
            <div class="content-header">
                <div class="leftside-content-header">
                    <ul class="breadcrumbs">
                        ...
                        <li><i class="fa fa-home" aria-hidden="true"></i><a href="#">公司文化</a></li>
                    </ul>
                </div>
            </div>
